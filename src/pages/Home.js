      ...
      <div className="row">
        <div className="row custom-flex">
          <div className="col s12 m8 l9">
            <div className="contenedorcentral">
              ...
              <br />
              <a href="#conocemas" class="boton">
                Conoce más
              </a>
              <br />
              <a id="primera-flecha" href="#conocemas" style={{display: "table", width: "5%", margin: "0 auto"}}>
        ...
        <div className="row" id="conocemas">
          <div className="col s12 m6 l6">
            <div className="contenedorcentral">
              ...
              <img className="linea-img" src={linea} />
              <p className="textoCenter">
              ...
              <img src={vinoculares} className="vinoculares hide-on-med-and-up" />
              <img src={vinoculares} className="vinoculares hide-on-small-only" />
              <br></br>
              <br></br>
              <br></br>
              <img src={sombra} />
          ...
          <div className="col s12 m6 l6">
            <div className="contenedorcentral">
              <img src={cuete} className="cuete hide-on-small-only" />
              ...
              <img src={cuete} className="hide-on-med-and-up" />
              <br />
            </div>
          </div>
        </div>
        ...
        <div className="row custom-flex" id="valores">
          ...
          <div className="col s12 m5 l5 height-diamante">
            ...
            <img className="align-diamante" src={diamante} />
            {/*<br></br>
                      <br></br>
                      <br></br>
                      <br></br>
